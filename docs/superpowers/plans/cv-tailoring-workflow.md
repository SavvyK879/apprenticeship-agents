...
- Before the draft is shown to the user, an independent subagent verifies every claim in it traces back to the master CV. Anything it can't verify gets fixed before the user sees it.
